...
import { User, GoldAuction } from '../generated/schema';
import {
  ActiveAuctionStatus,
  BuyGoldOrderType,
...
function getAuctionId(user: User | null, orderType: string): string | null {
  ...
  return orderType == SellGoldOrderType
    ? user.goldSellOffer
    : user.goldBuyOffer;
}
